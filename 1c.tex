...
\begin{document}
	...
	\begin{bidtable}{1c,1d}
		\he1 &  4+ \heartsuit, can have a longer minor, 1RF.  Unbalanced or semi-balanced. \\
	...
	\begin{bidtable}{1c,1d,1h}
		\sp1 & 4+ \spadesuit, any strength.  Typically fewer than 4 \heartsuit.  Most rebids are natural NF, \\
		...
		\cl2 & 2-- \heartsuit, (5)6 to 7.  \di2 is most minimums (scrambling), \he2 is natural and NF opposite 2= \hhh. Other GF.  2NT is a non-canap\'e GF, 3m is canap\'e.\\
		\di2 & 3= \heartsuit, (5)6 to 7. \he2 NF, \he3 Inv.  2NT GF asking for shortness NLMH, implies a heart fit. Other 1RF, usually canap\'e.\\
	...
	\orauction{1c,1d,1s} All auctions as per over \he1, except \he2 shows 5+ \heartsuit, (5)6--7.

	\orauction{1c,1d,1n} 17--19, systems on as per 1NT opening.
	...
	With \shape{5332} (minor), you can choose between showing your minor (direct \cl2 or \cl2 rebid) or showing a balanced no major (\sp2 rebid). Tom tends to treat it as balanced (\sp2) but do as you will.
	...
	\begin{warning}
		5= \sss~can be tricky if Opener starts with 1NT.  You may have to either bid \sp2 with no slam interest and hope to rebid \sp3 or bid \sp2 directly instead of 1NT.  Or give up on 5-3 spades and jump to \sp3 over \di2. 
	\end{warning}
