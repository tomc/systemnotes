...
\begin{document}
	...
	\ifbool{christian}
	{
		\begin{destable}
			...
			\he2 & Weak, 5--4 or better in the majors. \\ 
			2NT & 22-23\\
	...
	\begin{itemize}
		...
		\item Minimum responses to opening bids: while we pass \di1 freely up to 9 HCP, we follow more standard approaches to responding to 1M: respond with an Ace, a King and a 5 count or any 6 count.  Responding to \ifbool{christian}{\cl2}{2m} is a little different, passing is quite possible with 8 or so points, especially with no fit.  \ifbool{christian}{}{Even 10 or 11 counts are possible over \di2.}
	\end{itemize}	
	...
	\begin{destable}
		...
		+5 & \shape{5332}\\
		+6 and up & \shape{6322} or \shape{7222}.  +6 shows lowest side A/K, +7 denies that but shows the next and so on.  \\
	\end{destable}
