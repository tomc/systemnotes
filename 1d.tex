...
After \di1--\he1 opener is expected to bid \sp1 any time they have 4 spades including \exactshape{4x6x}. Again, opener may choose to bid 1NT instead but this is in principle non-systemic and I wouldn't expect to ever do it without \exactshape{4333}.  
  \ifbool{christian}
	{
		\begin{bidtable}{1d,1h}
			\sp1 & 4=\sss. Opener is expected to rarely bypass a 4-card spade suit. \\
			...
			\di3 & 6+\ddd, good hand. Notably \exactshape{xx64} has no other bid.\\
...
It is worth noting that \di1--\sp1--\he2 can be \exactshape{x46x}, you do not promise 5 hearts.
...
\begin{bidtable}{1d,2m}
	...
	om,R &  Natural, non-min. A raise can be passed, the om is GF. (Unbal GF raises start with \sp2.)\\
\end{bidtable}
...
For now, bids simply set trumps for further exploration however it may make sense to play some sort of Mulberry instead.  For reference, I'd want to use Kit's version, see \nameref{Kitberry} --- \ref{Kitberry}.
