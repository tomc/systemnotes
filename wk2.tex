...
+1 is 5/7 Ogust.  (\di2--\he2 or \sp2--2NT).  \di2--2NT is the forcing heart response, \sp2 is non-forcing.
...
\begin{bidtable}{2d/\sss,+1}
	...
	+3 & 6=, medium opener \\
	+4 & 6=, good opener \\
	 & \SetCell{bg=christian,fg=white,c} Over \di2 only \\
	\he3 & 4= \sss, 6= \ddd \\
	\sp3 & 4= \hhh, 6= \ddd \\
	3NT & 4= \ccc, 6= \ddd \\
	 & \SetCell{bg=christian,fg=white,c} Over \sp2 only \\
	3NT & 6= \sss, 4= \hhh \\
\end{bidtable}  

Over the 5/7 step, +1 re-asks for bad medium good steps.  Over \di2 we have room for 2 extra steps so we have preserved being able to show 4= majors:
